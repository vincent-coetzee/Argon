...
extension NSColor
    ...
    public static let argonBurntOrange = NSColor(red: 189,green: 113,blue: 70)
    ...
    public static let argonWhite80 = NSColor(hex: 0xCFCFCF)
    ...
    public static let argonWhite25 = NSColor(hex: 0x3D3D3D)
