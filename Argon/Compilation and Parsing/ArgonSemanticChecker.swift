...
public class ArgonSemanticChecker: Visitor
    ...
    public func enter(class: Class) {
        
    }
    
    public func exit(class: Class) {
        
    }
    
    public func enter(enumeration: Enumeration) {
        
    }
    
    public func exit(enumeration: Enumeration) {
    ...
    public func enter(function: Function) {
        
    }
    
    public func exit(function: Function) {
